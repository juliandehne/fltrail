...
<div class="row">
    <div class="col">
        ...
        <div class="row">
            <div class="col" style="margin-top: 10px;"><button class="btn btn-primary" type="button" style="width:
...
<div class="row">
    <div class="col">
        ...
        <div class="row">
            <div class="col"><button class="btn btn-primary" type="button" style="width: 200px;">Dossiers
