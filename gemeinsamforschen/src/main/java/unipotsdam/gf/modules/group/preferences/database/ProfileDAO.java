...
public class ProfileDAO {
    ...
    public java.util.List<ProfileQuestion> getQuestions() {
        ...
        String query =
                "SELECT (q.id,q.scaleSize, q.subvariable, q.question, q.question_en, o.name) from profilequestions q " + "LEFT JOIN " + "profilequestionoptions o where q.id = o" + ".profileQuestionId group by q.id";
