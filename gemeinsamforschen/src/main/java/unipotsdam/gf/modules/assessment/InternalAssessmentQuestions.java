...
public class InternalAssessmentQuestions {
    ...
    private ArrayList<QuestionData> getTheQuestions() {
        ...
        String verstaendnis2 = "Hat dir dieses Teammitglied klar und deutlich erklärt, wenn etwas unklar war?";
        ...
        LocalizedText problem2Min = new LocalizedText("great sharing", "sinnvolle Verteilung");
