...
public class InternalAssessmentQuestions {
    ...
    private ArrayList<QuestionData> getTheQuestions() {
        ...
        String zusammenarbeit2 = "Wie oft war dir klar, wie die Aufgaben verteilt waren und was dieses " +
                "Teammitglied macht?";
        ...
        String problem1 = "Wie oft konntest du mit diesem Teammitglied strukturiert und systematisch arbeiten?";
        LocalizedText problem1Min = new LocalizedText("always", "immer");
        LocalizedText problem1Max = new LocalizedText("rarely", "selten");
        String verstaendnis2 = "Wie hat dir dieses Teammitglied etwas erklärt, wenn etwas unklar war?";
        ...
        String zusammenarbeit3 = "Wie oft hat dein Teammitglied seine Vorgehensweise kommuniziert?";
        ...
        String zusammenarbeit1 = "Wie schätzt Du die generelle Zusammenarbeit dieses Teammitglieds in deiner Gruppe ein?";
