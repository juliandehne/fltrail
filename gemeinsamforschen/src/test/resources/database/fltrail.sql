...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='This table saves feedback for contributions';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='saves predefined learning goals';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='This table holds the task mapping i.e. which user should give feedback to which groups products';
...
CREATE TABLE `reflectionquestions` (
  ...
  `fullSubmissionId` varchar(120) DEFAULT NULL,
  `projectName` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='holds all reflection questions students have to answer or had answered';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='holds all predefined reflection questions.';
...
--
-- Tabellenstruktur für Tabelle `tasklock`
--
...
--
-- Indizes für die Tabelle `tasklock`
--
ALTER TABLE `tasklock`
  ADD UNIQUE KEY `id` (`id`);
...
--
-- AUTO_INCREMENT für Tabelle `tasklock`
--
ALTER TABLE `tasklock`
