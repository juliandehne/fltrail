                                ...
                                <div class="panel-heading">
                                    <div class="row">
                                        <div class="col col-xs-6">
                                            <h3 class="panel-title" style="margin-top:20px;">Projekte</h3>
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            ...
                            <div class="panel panel-default panel-table" style="width:550px">
                                <div class="panel-heading">
                                    <div class="row">
                                        <div class="col col-xs-6">
                                            <h3 class="panel-title" style="margin-top:20px;">Gruppen</h3>
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            ...
                            <div class="panel panel-default panel-table" style="width:550px">
                                <div class="panel-heading">
                                    <div class="row">
                                        <div class="col col-xs-6">
                                            <h3 class="panel-title" style="margin-top:20px;">Studenten</h3>
